...
dark_zurich_train_pipeline = [
    ...
    # dict(type='RandomCrop', crop_size=crop_size, cat_max_ratio=1.),  # is applied later in sepico_dark.py
    dict(type='RandomFlip', prob=0.5),
    # dict(type='PhotoMetricDistortion'),  # is applied later in sepico_dark.py
    dict(type='Normalize', **img_norm_cfg),
    # dict(type='Pad', size=crop_size, pad_val=0, seg_pad_val=255),  # is applied later in sepico_dark.py
    dict(type='DefaultFormatBundle'),
